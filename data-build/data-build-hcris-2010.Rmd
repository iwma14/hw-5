...
hcris_v2010_path <- function(year, suffix) {
  base <- "../data/input/hcris-data/HCRIS_v2010"
...
#write final csv
write_csv(final.hcris.v2010,'../data/output/HCRIS_Data_v2010.csv',append=FALSE,col_names=TRUE)
```
